...
if(isset($_POST["submit"]))
{
    ...
    $check = mysqli_query($conn,"insert into packages(package_name,Package_type,Package_detail,package_img) values('$_POST[name]','$_POST[type]','$_POST[detail]','$dst_db')");  // executing insert query
