...
$insert = 
mysqli_query($conn,"insert into contacts (name, email, phone, location, subject, message)values ('$_POST[name]','$_POST[email]','$_POST[phone]','$_POST[location]','$_POST[subject]','$_POST[message]')");
